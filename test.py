...
# Q&A 데이터 (총 10개)
qa_list = [
    {"카테고리": "입시 준비", "질문": "간호학과에 가려면 어떤 과목을 준비해야 하나요?", 
     "답변": "생명과학, 화학, 영어 과목이 중요하며, 논술이나 면접 대비도 필요합니다."},

    {"카테고리": "입시 준비", "질문": "면접에서 자주 묻는 질문은 무엇인가요?", 
     "답변": "간호사가 되고 싶은 이유, 힘든 상황을 극복한 경험, 봉사 경험 등을 자주 묻습니다."},

    {"카테고리": "입시 준비", "질문": "내신 성적은 얼마나 중요한가요?", 
     "답변": "대부분 대학에서 내신 반영 비율이 높으며, 특히 과학 과목 성적이 중요합니다."},

    {"카테고리": "대학 생활", "질문": "간호학과의 수업은 어떻게 구성되나요?", 
     "답변": "1~2학년은 기초의학 및 간호학 이론, 3~4학년은 임상 실습이 중심입니다."},

    {"카테고리": "대학 생활", "질문": "실습은 힘든가요?", 
     "답변": "체력적으로 힘들지만 환자를 직접 만나 배울 수 있어 보람이 큽니다."},

    {"카테고리": "대학 생활", "질문": "간호학과 동아리나 활동은 어떤 게 있나요?", 
     "답변": "대부분 봉사 동아리, 학술 소모임, 멘토링 프로그램이 운영됩니다."},

    {"카테고리": "진로", "질문": "병원 간호사 말고도 할 수 있는 일이 있나요?", 
     "답변": "제약회사, 보건소, 학교, 군대, 해외 취업 등 다양한 길이 있습니다."},

    {"카테고리": "진로", "질문": "간호사가 전문성을 높이려면 어떻게 해야 하나요?", 
     "답변": "전문간호사 과정, 석사·박사 진학, 해외 연수 등을 통해 전문성을 키울 수 있습니다."},

    {"카테고리": "해외 취업", "질문": "해외에서도 간호사로 일할 수 있나요?", 
     "답변": "추가 시험과 언어 능력이 필요하지만, 미국, 호주 등에서 활동 가능합니다."},

    {"카테고리": "해외 취업", "질문": "해외 취업 준비는 어떻게 하나요?", 
     "답변": "영어 등 언어 능력을 먼저 키우고, 국가별 간호사 면허 취득 조건을 확인해야 합니다."}
]
